...
import { WindowLoctor } from '../objectRepo/alertsFrameWindowsLocators';
...
export class BrowserWindowPage {
    ...
    async navigateToBrowserWindowPage() {
        try {
            await this.utils.waitAndClick(this.page.locator(WindowLoctor.alertsFrameWindowsMenu));
            await this.utils.waitAndClick(this.page.locator(WindowLoctor.browserWindowsMenu));
        } catch (error) {
    ...
    async clickNewTabButton() {
        try {
            await this.utils.waitAndClick(this.page.locator(WindowLoctor.newTabButton));
        } catch (error) {
    ...
    async clicknewWindowButton() {
        try {
            await this.utils.waitAndClick(this.page.locator(WindowLoctor.newWindowButton));
        } catch (error) {
    ...
    async clickNewMessageButton() {
        try {
            const newMessageButton = this.page.locator(WindowLoctor.messageWindowButton);
